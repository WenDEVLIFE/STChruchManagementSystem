        ...
        if (selectedValue != null && selectedValue.equals("Submit")) { // "Submit" button clicked
            ...
            if (childName.isEmpty() || parentName.isEmpty() || contactNumber.isEmpty() || date.isEmpty() || timeSlot.isEmpty()) {
                ...
                try {
                    ...
                    DateTimeFormatter timeFormatter = DateTimeFormatter.ofPattern("hh:mm a"); // e.g., "08:00 AM"
                    LocalTime enteredTime = LocalTime.parse(timeSlot, timeFormatter);
                    LocalTime startTime = LocalTime.of(8, 0);  // 08:00 AM
                    LocalTime endTime = LocalTime.of(16, 0);   // 04:00 PM

                    if (enteredTime.isBefore(startTime) || enteredTime.isAfter(endTime)) {
                        javax.swing.JOptionPane.showMessageDialog(this, "Please enter a time between 08:00 AM and 04:00 PM.", "Error", javax.swing.JOptionPane.ERROR_MESSAGE);
                        return;
                    }
